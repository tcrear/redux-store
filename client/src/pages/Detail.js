...
function Detail() {
  ...
  // Get the current state from the useSelector hook
  ...
  // Get products and cart from the Redux state, because that's what we need below
  ...
  useEffect(() => {
    ...
    // retrieved from server
      ...
      // use the dispatch hook to call the UPDATE_PRODUCTS reducer and update state
      dispatch({
